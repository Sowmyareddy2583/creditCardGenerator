    ...
    <div className="credit-card-form-div">
      <form className="credit-card-form" onSubmit={handleFormSubmit}>
        ...
        <div className="form-field">
          ...
          <input type="text" className="credit-card-input-field" name="cardHolderName"  id="cardHolderName" value={inputValue.cardHolderName} onChange={changeHandler} placeholder='e.g. SOWMYA REDDY' required/>
